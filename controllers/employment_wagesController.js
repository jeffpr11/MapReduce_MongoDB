...
module.exports = {
    ...
    update: function (req, res) {
        ...
        Employment_wagesModel.findOne({_id: id}, function (err, employment_wages) {
			...
			employment_wages.fields.area_title = req.body.fields.area_title ? req.body.fields.area_title : employment_wages.fields.area_title,			
			employment_wages.fields.industry_code = req.body.fields.industry_code ? req.body.fields.industry_code : employment_wages.fields.industry_code,
			employment_wages.fields.industry_title = req.body.fields.industry_title ? req.body.fields.industry_title : employment_wages.fields.industry_title,
			employment_wages.fields.total_qtrly_wages = req.body.fields.total_qtrly_wages ? req.body.fields.total_qtrly_wages : employment_wages.fields.total_qtrly_wages,
			employment_wages.fields.avg_wkly_wage = req.body.fields.avg_wkly_wage ? req.body.fields.avg_wkly_wage : employment_wages.fields.avg_wkly_wage,
			employment_wages.fields.period = req.body.fields.period ? req.body.fields.period : employment_wages.fields.period,
			employment_wages.fields.month1_emplvl = req.body.fields.month1_emplvl ? req.body.fields.month1_emplvl : employment_wages.fields.month1_emplvl,
        	employment_wages.save(function (err, employment_wages) {
                if (err) {
                    return res.status(500).json({
